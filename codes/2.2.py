##### Hauptprogramm mit rollenbasiertem Tool-Zugriff #####
...
# ============================================================================
# KONFIGURATION: Tools pro Abteilung
# ============================================================================
...
class HauptprogrammWindow:
    ...
    def create_widgets(self):
        """Erstellt GUI-Elemente für Hauptfenster"""
    ...
    def create_dropdown_tools(self, parent):
        """
        Erstellt ein Dropdown-Menü mit verfügbaren Tools
        ...
        # Bind Dropdown-Änderungen zum Aktualisieren der Beschreibung
